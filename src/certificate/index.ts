...
// https://registry.terraform.io/providers/vancluever/acme/2.46.2/docs/resources/certificate
...
export class Certificate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Certificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/vancluever/acme/2.46.2/docs/resources/certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vancluever/acme/2.46.2/docs/resources/certificate acme_certificate} Resource
  *
  * @param scope The scope in which to define this construct
