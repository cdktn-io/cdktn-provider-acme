...
// https://registry.terraform.io/providers/vancluever/acme/2.47.0/docs/data-sources/server_url
...
export class DataAcmeServerUrl extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAcmeServerUrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/vancluever/acme/2.47.0/docs/data-sources/server_url#import import section} in the documentation of this resource for the id to use
