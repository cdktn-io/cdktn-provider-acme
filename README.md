...
# CDKTN prebuilt bindings for vancluever/acme provider version 2.48.1

This repo builds and publishes the [Terraform acme provider](https://registry.terraform.io/providers/vancluever/acme/2.48.1/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform acme provider](https://registry.terraform.io/providers/vancluever/acme/2.48.1)
